...
<body>
    ...
    <main>
        ...
        <article class="manfaat" id="manfaat">
            ...
            <div class="box-image">
                <div class="box manfaat-1">
                    <figure>
                        <img src="img/trash.png" alt="banjir">
                    </figure>
                    <figcaption>
                        <h3>Mengurangi</h3>
                ...
                <div class="box manfaat-2">
                    <figure>
                        <img src="img/holding-hand.png" alt="banjir">
                    </figure>
                    <figcaption>
                        <h3>Menjaga</h3>
                ...
                <div class="box manfaat-3">
                    <figure>
                        <img src="img/recycle-sign.png" alt="banjir">
                    </figure>
                    <figcaption>
                        <h3>Memudahkan</h3>
                ...
                <div class="box manfaat-4">
                    <figure>
                        <img src="img/flood.png" alt="banjir">
                    </figure>
                    <figcaption>
                        <h3>Mencegah</h3>
        ...
        <section class="solusi" id="solusi">
            ...
            <img src="img/Tanya.png" alt="stress" class="stress">
            <div class="box-solusi">
                ...
                <div class="kotak sampah">
                    <img src="img/trash.png" alt="sampah">
                ...
                <div class="kotak penebangan">
                    <img src="img/deforestation.png" alt="penebangan">
    ...
    <footer>
        ...
        <div class="box-card">
            <div class="card firzan">
                <img src="img/firzan.jpg" alt="firzan" class="firzan">
                <figcaption>
            ...
            <div class="card eni">
                <img src="img/eni.jpg" alt="firzan">
                <figcaption>
                    <h1>Nur Aini</h1>
                    <p>23091397077</p>
                    <p>2023C</p>
            ...
            <div class="card">
                <img src="img/dafa.jpeg" alt="firzan" class="dafa">
                <figcaption>
                    <h1>Dafa Alvin</h1>
                    <p>23091397083</p>
                    <p>2023C</p>
